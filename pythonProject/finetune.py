...
def finetune(novel_loader, n_query = 15, pretrained_dataset='miniImageNet', n_way = 5, n_support = 5):
    correct = 0
    count = 0
...
if __name__=='__main__':
    ...
    for idx, novel_loader in enumerate(novel_loaders):
        ...
        finetune(novel_loader, n_query = 15, pretrained_dataset=pretrained_dataset, **few_shot_params)
